...
class Vimeo90KDataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        self.paths_GT = sorted(pickle.load(open('./data/{}'.format(cache_keys), 'rb'))['keys'])
    ...
    def __getitem__(self, index):
        ...
        img_GT = util.read_img(self.GT_env, key + '_4', (3, 2160, 3840))
        # if self.data_type == 'mc':
...
# GT_env = lmdb.open('/home/shanda2/EDVR-dev/codes/dataset/train_gt_wval.lmdb', readonly=True, lock=False, readahead=False,
#                                 meminit=False)
# img_GT = util.read_img(GT_env, '00001_0002_4', (3, 2160, 3840))
# print(img_GT.shape)